...
export const en = {
  ...
  shop: {
    ...
    mandatory_kit_one: 'Mandatory Kit ({{count}} item)',
    mandatory_kit_other: 'Mandatory Kit ({{count}} items)',
    buy_all_mandatory: 'Buy all mandatory items for the school year.',
    complete_kit_one: 'Complete Kit ({{count}} item)',
    complete_kit_other: 'Complete Kit ({{count}} items)',
    ...
    no_reading_plan_selected_title: 'Select a Grade to View the Reading Plan',
    no_reading_plan_selected_description: 'Choose one of the grades above to see the mandatory and recommended books for the school.',
  ...
  books_page: {
    ...
    description_placeholder: 'Brief description of book...',
    ...
    didactic_aids: 'Didactic Aids',
    outros: 'Others',
    delete_warning: 'This item has an image. Deleting it will also remove image from storage. This action cannot be undone.',
  },
  games_page: {
